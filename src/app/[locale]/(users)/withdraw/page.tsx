    ...
    <div className="user_withdraw_container">
      ...
      <div className="user_withdraw_container_001">
        <form onSubmit={handleSubmit} className="withdraw-form-container">
          ...
          >
            {t("withdraw_page.submit_details")}
          </p>
          ...
          <input
            ...
            placeholder={t("withdraw_page.enter_withdrawal_amount")}
          />
          <label>Montant</label>
          <input
            type="number"
            ...
            placeholder={t("withdraw_page.enter_amount")}
          />
          <label>{t("withdraw_page.momo_name")}</label>
          <input
            type="text"
            className="withdraw-form"
            value={user.momoName}
            onChange={handleMomoname}
            placeholder={t("withdraw_page.enter_momo_name")}
          />
