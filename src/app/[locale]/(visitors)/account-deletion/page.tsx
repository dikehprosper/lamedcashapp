...
"use client";
import AccountDeletionSection from "@/components/(AccountDeleteSection)/accountDelete";
...
const About = async () => {
  ...
  return updatedTheme === "dark" ||
    (updatedTheme === "light" && updatedLang === "fr") ||
    updatedLang === "en" ? (
    <div
      style={{
    ...
    >
      <AccountDeletionSection updatedTheme={updatedTheme} updatedLang={updatedLang} />
