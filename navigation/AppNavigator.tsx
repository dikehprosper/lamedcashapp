...
function WalletNavigator() {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen name='searchSendingPage' component={SearchSendingPage} />
...
function MainNavigator() {
  ...
  return (
      ...
      screenOptions={({route}) => ({
        ...
        tabBarIcon: ({color}: any) => {
          if (route.name === languageText.text164) {
            return <FontAwesome5 name='home' color={color} size={22} />;
          } else if (route.name === languageText.text116) {
            return (
              <Ionicons name='person-circle-sharp' size={25} color={color} />
            );
          } else if (route.name === languageText.text165) {
            return (
              <MaterialCommunityIcons name='post' size={23} color={color} />
            );
    ...
    >
      <Tabs.Screen name={languageText.text164} component={HomeNavigator} />
      <Tabs.Screen name={languageText.text165} component={CommunityNavigator} />
      ...
      <ModalProvider>
        <NavigationContainer linking={linking}>
          ...
          >
            ...
            <Stack.Screen name='setAuthScreen' component={setAuthScreen} />
            <Stack.Screen name='setAuthScreen1' component={SetAuthScreen1} />
            ...
            <Stack.Screen name='FixturesDay' component={FixturesDay} />
            ...
            <Stack.Screen name='receiveReceipt' component={ReceiveReceipt} />
            <Stack.Screen
            ...
            />
            <Stack.Screen name='sentReceipt' component={SentReceipt} />
            <Stack.Screen name='depositReceipt' component={DepositReceipt} />
            <Stack.Screen name='changePin' component={ChangePin} />
            <Stack.Screen name='changePin2' component={ChangePin2} />
            <Stack.Screen name='SetAuthScreen3' component={SetAuthScreen3} />
            <Stack.Screen name='SetAuthScreen4' component={SetAuthScreen4} />
