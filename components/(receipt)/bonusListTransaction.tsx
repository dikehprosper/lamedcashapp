...
const BonusListTransaction = ({specificData, navigation}: any) => {
  ...
  console.log(specificData, "user.betId");
      ...
      >
        <View
          style={{
            ...
            justifyContent: "center",
            alignItems: "center",
            paddingRight: specificData.fundingType === "deposits" ? 3.1 : 0,
            paddingLeft: specificData.fundingType === "deposits" ? 0 : 4,
          }}
        >
          {specificData.fundingType === "bonus" ||
        ...
        <View style={styles.small_device_group}>
          ...
          >
            {specificData.fundingType === "deposits" ? (
              ...
              <TruncatedText
                text={`${specificData.recipientTag}`}
                maxLength={12}
              />
            ) : (
              specificData.betId
          ...
          >
            {specificData.fundingType === "deposits" ? (
              <TruncatedText text={languageText.text95} maxLength={12} />
            ) : specificData.fundingType === "send" ? (
              <TruncatedText
              ...
              <TruncatedText text={languageText.text98} maxLength={12} />
            ) : (
              <TruncatedText text={languageText.text99} maxLength={12} />
            )}
          </Text>
        </View>
