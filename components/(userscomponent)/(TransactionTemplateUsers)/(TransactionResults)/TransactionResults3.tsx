...
// };
const imageSource = {
    uri: "https://firebasestorage.googleapis.com/v0/b/groupchat-d6de7.appspot.com/o/apple-touch-icon.png?alt=media&token=8edd60b9-6038-4874-9a0b-6385f1a1dcad",
};
        ...
        >
            ...
            >
                ...
                <View style={styles.small_device_group}>
                    ...
                    >
                        <TruncatedText text={textToDisplay} maxLength={30} />
                    </Text>
                </View>
            </TouchableOpacity>
            <TouchableOpacity
