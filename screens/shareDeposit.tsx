        ...
        dispatch(genarateQRCode(formData))
            .then(async (result) => {
                if (result.payload.success === true) {
                    try {
                        setQRCodeValue(
                            `https://community.betfundr.com/deposits/${result.payload.id}`,
                        );
                        setLoading3(false);
                    } catch (err) {
                        console.log(err);
    ...
    const shareQRCode = async () => {
        try {
            ...
            const result = await Share.share({
                message: `Cliquez/scannez pour compléter/scanner le dépôt pour Moïse sur Betfundr..... ${qrCodeValue} `,
                url: uri,
            });
                            ...
                            >
                                {loading3 ? (
                                    ...
                                    >
                                        ...
                                        entrez les détails pour générer
                                    </Text>
                                )}
