...
import {printToFile} from "@/components/(Utils)/htmlTemplate";

const image = require("@/assets/images/Logo.webp");
const image1 = require("@/assets/images/Logo.webp");

const TransactionHistorySpecific = ({route}: any) => {
...
export default TransactionHistorySpecific;
